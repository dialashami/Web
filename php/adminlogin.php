...
$_SESSION['islogin1']=0;
$valid1=0;
if(isset($_POST['name']) && isset($_POST['passs']) ){
    ...
    for($i=0 ; $i< $res -> num_rows ; $i++){
        ...
        if ($_POST['name']==$row[0] && $_POST['passs']==$row[1] ){
            // valid
            $_SESSION['islogin1']=1;
            $valid1=1;
            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter username">
                        <input class="input100" type="text" id="name" name="name" placeholder="Email">
                        <span class="focus-input100" data-placeholder="&#xf207;"></span>
                    </div>

                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                        <input class="input100" type="password" id="passs" name="passs" placeholder="Password">
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                    </div>
